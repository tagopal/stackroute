...
//       res.body.newUser.should.be.equal('koushic', 'Response body should have a key as userInfo which will hold username value');
...
//           user.username.should.be.equal('koushic');
//           done();
//         }
//     });
//   });
