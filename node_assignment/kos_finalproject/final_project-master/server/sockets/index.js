                        ...
                        userInfoModel.find({ userId: response[0]._id }, (err, res) => {
                            ...
                            if (err) {
                                ...
                                if(!res.length){
                                    ...
                                    // userInfo.sharedNoteList=[];
                                    // if()
                                    // userInfo.sharedNoteList.forEach(shareInfo=>{
                                    //     if(shareInfo.userId==data.sender.userId){
                                    //         flag=1;
                                    //         console.log(shareInfo.noteIds);
                                    //         data.sender.notes.forEach(note=>{
                                    //             console.log(note._id);
                                    //             if(!shareInfo.noteIds.includes(note._id)){
                                    //                 shareInfo.noteIds.push(note._id);
                                    //             }
                                    //         })
                                    //     }
                                    // })
                                    ...
                                    // if(flag==0){
                                    //     var obj={userName:data.sender.userName,userId:data.sender.userId,noteIds:noteIds}
                                    //     userInfo.sharedNoteList.push(obj)
                                    // }
                                    console.log(userInfo);
                                    // userInfo.userId=data.updateUserId;
                ...
                if (err) {
                    ...
                    if(!response.length){
                        ...
                        if(data.state){
                            ...
                            // response[0].labels = response[0].labels.filter(label=>label.name!=data.label);
                        }
                        console.log("inserting data");
                        console.log(response[0]);
                        userInfoModel.findOneAndUpdate({ userId: data.userId },response[0],{upsert: true},(err,data)=>{
